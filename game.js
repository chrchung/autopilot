...
app.controller('gameCtrl', function($scope, Restangular, $state) {
    ...
    $scope.tutorial = {numTutorials: 4, show: false, state: 0, attempts: 0, sucAttempts: 0, info: {
    ...
    function start() {
        ...
        if ($scope.tutorial.info[$scope.tutorial.sucAttempts]) {
            ...
            $scope.modelNames = shuffle($scope.modelNames); // randomize the order for which models appear in game
            $scope.positions = positions;
        } else if ($scope.tutorial.sucAttempts < 4) {
            settings = $scope.tutorial.info[1];
        } else if ($scope.tutorial.sucAttempts < 7) {
            settings = $scope.tutorial.info[4];
        }
